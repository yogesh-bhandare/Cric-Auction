...
class AddAuctionAdmin(admin.ModelAdmin):
    list_display = ("user", "auction_name", "auction_date", "auction_type", "auction_purse", "min_bid", "bid_increase", "players_per_team", "created", "modified")
...
class AddPlayerAdmin(admin.ModelAdmin):
    list_display = ("auction", "player_name", "player_type", "origin", "base_price", "player_points", "created", "modified")
    search_fields = ("player_name",)
    list_filter = ("player_type", "origin", "base_price", "player_points")

class AddTeamAdmin(admin.ModelAdmin):
    list_display = ("auction", "team_username", "team_name", "purse_amt", "created", "modified")
    search_fields = ("team_name",)

class AddSponsersAdmin(admin.ModelAdmin):
    list_display = ("auction", "sponser_name")

class AuctionResultAdmin(admin.ModelAdmin):
    list_display = ("auction", "player", "team", "sold_price", "status")
